...
//static nodo* getNode(LinkedList* lista, int nodo_index);
//static int addNode(LinkedList* lista, int nodo_index,void* p_elemento);
 ...
 *
 */
nodo* test_getNode(LinkedList* lista, int nodo_index)
{
    return getNode(lista, nodo_index);
}
...
static int addNode(LinkedList* lista, int nodo_index, void* p_elemento)
{
    ...
    if(lista != NULL  && nodo_index >= 0 && nodo_index <= ll_len(lista))
    {
        ...
        if(nuevo_nodo != NULL)
        {
            ...
            {
                anterior = getNode(lista, nodo_index - 1);
 ...
 *
 */
int test_addNode(LinkedList* lista, int nodo_index, void* p_elemento)
{
    return addNode(lista, nodo_index, p_elemento);
}
...
{
    return addNode(lista, ll_len(lista), p_elemento);
}
...
{
    return addNode(lista, index, p_elemento);
}
    ...
    if(lista != NULL && (*p_func) != NULL && orden >= 0 && orden <= 1)
    {
        ...
        for(int i = 0; i < tam - 1; i++)
        {
            for(int j = i + 1; j < tam; j++)
            {
                ...
                {
                    aux_element = ll_get(lista, i);
                    ll_set(lista, i, ll_get(lista, j));
                    ll_set(lista, j, aux_element);
                }
    ...
    if(lista != NULL && (*p_func) != NULL)
    {
        ...
        if(lista_filtrada != NULL)
        {
            for(int i = 0; i < tam; i++)
            {
                ...
                if(p_func(aux_element))
                {
                    ll_add(lista_filtrada, aux_element);
                }
            }
        }
    }
